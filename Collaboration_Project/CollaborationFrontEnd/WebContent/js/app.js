...
app.config(function($routeProvider) { // configuring route provider
	...
	*/
	...
	// to view list of pending friend requests
	.when('/pendingRequest', {
		controller : 'FriendController',
	...
	// to termsofservice
	.when('/termsofservice',{
		templateUrl:'c_home/termsofservice.html'
	})
	
	
	// to privacy
	.when('/privacy',{
		templateUrl:'c_home/privacy.html'
	})
	
	
	// to contentpolicy
	.when('/contentpolicy',{
		templateUrl:'c_home/contentpolicy.html'
	})
